...
/*** UART registers ***/
#define UARTBAUD        UBRR0L           // UART Baud Rate Register Low
#define UARTSTATUS      UCSR0A           // UART Status Register
#define UARTCONTROL     UCSR0B           // UART Control Register
#define UARTDATA        UDR0             // UART Data Register

#define UARTTXEN        TXEN0            // Transmitter Enable Bit
#define UARTRXEN        RXEN0            // Receiver Enable Bit
#define UARTTXC         TXC0             // Transmit Complete Bit
#define UARTRXC         RXC0             // Receive Complete Bit
#define UARTUDRE        UDRE0            // UART Data Register Empty Bit
