...
%TOOL% -ccom1 -I57600 -d%CPU% -s -f%CAL_FUSES% -e -pf -if"..\rc_calib.hex"
...
%TOOL% -ccom1 -d%CPU% -ae0,0 -ve -ie0xFF_byte.hex
...
%TOOL% -ccom1 -d%CPU% -e -pf -vf -if%CUSTOMERCODE% -Z0 -Sf0x01FF
