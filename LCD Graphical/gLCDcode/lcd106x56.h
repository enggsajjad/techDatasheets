...
sbit LCD_RST = P3^0;				/* port bit for Display Reset */
sbit LCD_CS = P3^1;					/* port bit for Chip Select */
sbit LCD_CD = P3^2;					/* port bit for Control/Data Select */
sbit LCD_SCLK = P3^4;				/* port bit for the Serial Clock */
sbit LCD_SDAT = P3^6;				/* port bit for the Serial Data */
